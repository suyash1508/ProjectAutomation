...
public class OMgmtC_1 {
	...
	public static void main(String[] args) {
		...
		@Test
		public static void case1() throws InterruptedException, WebDriverException, IOException {
...
//			caps.setCapability("skipDeviceInitialization", "true");
			...
			caps.setCapability("appPackage", "com.bazaarplus.pula");
			caps.setCapability("appActivity", "com.bazaarplus.pula.MainActivity");
	       ...
	       WebDriverWait wait1 = new WebDriverWait(driver, 20);
			 wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Orders']")));
			 driver.findElement(By.xpath("//*[@text='Orders']")).click();
			 wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text='add_order']")));
		   ...
		   driver.hideKeyboard();
			...
			driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.app.Dialog/android.view.View/android.view.View[5]/android.view.View[2]/android.widget.EditText\r\n" + 
			 ...
			 Thread.sleep(500);
			 driver.findElement(By.xpath("//*[@text='I will manage my own payment']")).click();
			 Thread.sleep(500);
